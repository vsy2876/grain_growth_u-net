...
CHECKPOINT_DIR  = "./checkpoints_1_frame"
FINAL_MODEL_DIR = "./final_model_1_frame"
VIZ_DIR         = "./visualizations_model_1_frame"
...
NUM_PAST_FRAMES   = 1    # e.g., T=0, 100, 200 (9 channels in)
